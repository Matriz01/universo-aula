// src/scenes/shaders/sun.lite.frag
// Fragment shader lite del Sol — GPUs débiles (low).
// Versión reducida: sólo capa 1 de granulación, sin flujo radial, sin sunspots.
// ~40% menos instrucciones GLSL respecto a sun.frag.
//
...
void main() {
  ...
  // Sólo capa 1: granulación lenta (sin flujo radial ni sunspots)
